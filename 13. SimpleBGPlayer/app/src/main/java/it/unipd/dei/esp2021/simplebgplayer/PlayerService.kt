...
class PlayerService : Service()
{
    ...
    override fun onCreate()
    {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            // Note: with IMPORTANCE_LOW, notifications may or may not not appear
            // in the status bar depending on user preference. See also
            // https://developer.android.com/reference/android/app/NotificationManager#shouldHideSilentStatusBarIcons()
    ...
    private fun play()
    {
        ...
        // To support API level 25 or lower, call setPriority() for each notification
